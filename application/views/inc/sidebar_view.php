                ...
                <li class="nav-item dropdown dropdown-authentication">
                    <a class="nav-link dropdown-toggle no-caret" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <span>Hi!<i class="zmdi zmdi-chevron-down"></i></span>
                            </div>
                        </div>
                    </a>
            ...
            <div class="nicescroll-bar">
                <div class="navbar-nav-wrap">
                    ...
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?=site_url('staffvote/viewresult')?>">
                                <span class="feather-icon"><i data-feather="user"></i></span>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?=site_url('staffvote/viewnominees')?>">
                                <span class="feather-icon"><i data-feather="user"></i></span>
                                <span class="nav-link-text">The Nominees Are!</span>
                            </a>
                            <ul id="tables_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?=site_url('admin/viewstaff')?>" target="_blank">
                                <span class="feather-icon"><i data-feather="user"></i></span>
                                <span class="nav-link-text">Confirm Email</span>
                            </a>
                            <ul id="tables_drp" class="nav flex-column collapse collapse-level-1">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
