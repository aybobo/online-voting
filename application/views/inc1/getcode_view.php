...
Enjoy!
                    ...
                    <div class="col-xl-7 pa-0">
                        ...
                        <div class="auth-form-wrap py-xl-0 py-50">
                            <div class="auth-form w-xxl-55 w-xl-75 w-sm-90 w-xs-100">
                                ...
                                <?php echo form_open('Admin/postcode', ['class' => 'form-signin']); ?>
                                    ...
                                    <button class="btn btn-success btn-block" type="submit">Get Access Code</button>
                                    <p class="font-14 text-center mt-15"><a href="<?=site_url('admin/getcode')?>" class="forgot-password">
                    ...
                    <!--<p class="font-14 text-center mt-15"><a href="<?=site_url('admin/testrun')?>" class="forgot-password">
                        Run Code
                    </a></p>-->
